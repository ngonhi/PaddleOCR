...
from vqa_utils import parse_args, get_bio_label_maps_idcard, print_arguments
...
def eval(args):
    ...
    label2id_map, id2label_map, entities_label2id_map = get_bio_label_maps_idcard(args.label_map_path)
