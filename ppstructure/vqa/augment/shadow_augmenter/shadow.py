...
if __name__ == "__main__":
	...
	image = cv2.cvtColor(cv2.imread('/mnt/ssd/marley/ID_Card/Fake-Data-Generator/result_data/aug_cc_chip_back/chip_back_0.jpg'), cv2.COLOR_BGR2RGB)
	image = add_n_shadows(image, intensity=0.5)
