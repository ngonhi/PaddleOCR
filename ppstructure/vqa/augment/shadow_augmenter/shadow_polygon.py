...
import cv2
import numpy as np
from . import shadow_mask as mask
...
if __name__ == "__main__":
	img = cv2.imread("/media/geneous/01D62877FB2A4900/Techainer/OCR/lib_layout_aru/insert_poly/invalid_insert_text_4.jpg")

	mask = add_polygon_shadow(img)
	print(mask.shape)
	cv2.imshow("raw", img)
	cv2.imshow("", mask)
	cv2.waitKey(0)