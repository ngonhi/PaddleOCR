...
from idcard import IDCardDataset
from vqa_utils import parse_args, get_bio_label_maps_idcard, print_arguments, set_seed
from eval_ser_idcard import evaluate
...
def train(args):
    ...
    label2id_map, id2label_map, entities_label2id_map = get_bio_label_maps_idcard(args.label_path)
    ...
    train_dataset = IDCardDataset(
        tokenizer,
        image_data_dir=args.image_data_dir,
        label_path=args.train_label_path,
        label2id_map=label2id_map,
        entities_label2id_map=entities_label2id_map,
        img_size=(224, 224),
    ...
    for epoch_id in range(args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            ...
            if args.ser_model_type == 'LayoutXLM':
                outputs = outputs[0]
            if args.ser_model_type == 'LayoutLMv2':
                outputs = outputs[0]
